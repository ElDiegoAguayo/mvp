...
const ACTION_GROUPS: Record<ActionFilter, AuditActionType[]> = {
  all:      [],
  creation: ['CREATE_USER', 'CREATE_SUBUSER', 'CREATE_MODULE', 'CREATE_DYNAMIC_TABLE', 'CREATE_CHART', 'FOLDER_CREATE', 'FILE_UPLOAD', 'CREATE_BACKUP', 'CREATE_ADMIN_NOTIFICATION'],
  update:   ['UPDATE_PERMISSION', 'UNBLOCK_USER', 'UPDATE_USER', 'UPDATE_MODULE', 'UPDATE_TABLE_COLUMNS', 'UPDATE_CHART', 'UPDATE_PASSWORD', 'UPDATE_DATA_ACCESS', 'FILE_MOVE', 'BULK_FILE_MOVE', 'UPDATE_DASHBOARD_LAYOUT', 'UPDATE_PLATFORM_DASHBOARD', 'UPDATE_MODULE_ORDER', 'UPDATE_MODULE_AREA', 'UPDATE_CLIENT_DATA', 'UPDATE_ADMIN_NOTIFICATION', 'UNBLOCK_IP', 'UPDATE_MAINTENANCE_MODE'],
  deletion: ['BLOCK_USER', 'DELETE_MODULE', 'DELETE_DYNAMIC_TABLE', 'DELETE_CHART', 'FILE_DELETE', 'FOLDER_DELETE', 'DELETE_IMPORT', 'DELETE_ADMIN_NOTIFICATION', 'BLOCK_IP'],
  restore:  ['RESTORE', 'RESTORE_BACKUP'],
  system:   ['SYSTEM', 'IMPORT_EXCEL', 'CREATE_BACKUP'],
  files:    ['FILE_UPLOAD', 'FILE_DOWNLOAD', 'FILE_DELETE', 'FILE_MOVE', 'FILE_SHARE', 'BULK_FILE_MOVE', 'FOLDER_CREATE', 'FOLDER_DELETE'],
  auth:     ['LOGIN_SUCCESS', 'LOGIN_FAILED', 'LOGIN_BLOCKED_BY_RATE_LIMIT', 'LOGIN_BLOCKED_IP', 'LOGIN_BLOCKED_MAINTENANCE', 'LOGOUT'],
}
