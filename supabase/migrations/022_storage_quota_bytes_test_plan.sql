-- Plan de prueba 1 MB: cuota exacta en bytes (override opcional de storage_quota_gb)
ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS storage_quota_bytes bigint;

COMMENT ON COLUMN profiles.storage_quota_bytes IS
  'Override de cuota en bytes (ej. 1048576 = 1 MB prueba). Si es NULL, se usa storage_quota_gb.';
